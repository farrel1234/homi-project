...
fun FormSuratKeteranganUsahaScreen(
    ...
    Scaffold(
        ...
        Column(
            ...
            Text(
                text = "Isi data untuk pembuatan Surat Keterangan Usaha.\nSurat ini dipakai untuk administrasi usaha warga.",
                fontFamily = poppins,
                color = Color.White,
                fontSize = 13.sp,
                lineHeight = 18.sp,
                ...
                Card(
                    ...
                    Column(
                        ...
                        FieldBox(
                            label = "Nama Usaha",
                            value = namaUsaha,
                            onChange = { namaUsaha = it },
                            poppinsSemi = poppinsSemi,
                            placeholder = "Contoh: Warung Sembako Bu Rina"
                        )

                        FieldBox(
                            label = "Jenis Usaha",
                            value = jenisUsaha,
                            onChange = { jenisUsaha = it },
                            poppinsSemi = poppinsSemi,
                            placeholder = "Contoh: Kuliner / Sembako / Jasa"
                        )

                        FieldBox(
                            label = "Alamat Usaha",
                            value = alamatUsaha,
                            onChange = { alamatUsaha = it },
                            poppinsSemi = poppinsSemi,
                            placeholder = "Alamat lokasi usaha (bisa sama dengan alamat rumah)",
                            singleLine = false,
                            maxLines = 3,
                            height = 90.dp
                        )
                        ...
                        FieldBox(
                            ...
                            poppinsSemi = poppinsSemi,
                            placeholder = "Contoh: Persyaratan administrasi / Pengajuan bantuan",
                            singleLine = false,
                            maxLines = 3,
                            height = 90.dp
                        )
