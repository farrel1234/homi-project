...
<div class="grid md:grid-cols-2 gap-4">
    ...
    <div>
        ...
        <input name="full_name" value="{{ old('full_name', $u->full_name ?? $u->name ?? '') }}"
               class="w-full rounded-xl border-gray-300 px-3 py-2 focus:border-[#1f6f8b] focus:ring-[#1f6f8b]" />
    ...
    <div class="md:col-span-2">
        ...
        <textarea name="alamat" rows="3"
                  class="w-full rounded-xl border-gray-300 px-3 py-2 focus:border-[#1f6f8b] focus:ring-[#1f6f8b]">{{ old('alamat', $item->alamat ?? '') }}</textarea>
