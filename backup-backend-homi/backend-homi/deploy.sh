...
# ─── FIX STORAGE: Pastikan folder ada dan permission benar ─────
echo ""
echo "🔧 Mempersiapkan folder storage..."
mkdir -p storage/app/public/announcements
mkdir -p storage/app/public/payment_qr_codes
mkdir -p storage/app/public/payment_proofs
# Permission: www-data (uid 33) atau user homi (uid 1000)
chmod -R 775 storage/
