...
Route::prefix('admin')->group(function () {
    ...
    Route::middleware('auth')->group(function () {
        ...
        // ===================== KHUSUS ADMIN PERUMAHAN (TENANT) =====================
        Route::middleware('is_admin')->group(function () {
            Route::get('/prioritas-tunggakan', [PrioritasTunggakanController::class, 'index'])->name('admin.prioritas-tunggakan');
            ...
            Route::post('residents/import', [ResidentController::class, 'importCsv'])->name('residents.import');
            Route::get('residents/template.csv', [ResidentController::class, 'downloadTemplate'])->name('residents.template');
            ...
            Route::resource('service-requests', AdminServiceRequestController::class)->only(['index', 'show', 'update']);
            ...
            Route::get('service-requests/{serviceRequest}/preview', [AdminServiceRequestController::class, 'preview'])->name('service-requests.preview');
            ...
            Route::get('service-requests/{serviceRequest}/download', [AdminServiceRequestController::class, 'download'])->name('service-requests.download');
            ...
            Route::post('payments/{payment}/scan-ocr', [PaymentOcrController::class, 'scan'])->name('payments.scan-ocr');
            ...
            Route::prefix('notifications')->name('admin.notifications.')->group(function () {
                ...
                Route::post('/send-risk/{userId}', [AppNotificationController::class, 'sendRiskWarning'])->name('send-risk');
            });
        });

        // ===================== KHUSUS ADMIN PUSAT (SUPER ADMIN) =====================
        Route::middleware('is_superadmin')->group(function () {
            Route::resource('staff', StaffController::class)->names('admin.staff')->parameters(['staff' => 'staff']);
            ...
            Route::match(['get', 'post'], 'tenant-requests/{tenantRequest}/approve', [AdminTenantRequestController::class, 'approve'])->name('tenant-requests.approve');
        });
    });
});